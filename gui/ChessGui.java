...
import ch07.logic.IPlayerHandler;
import ch07.logic.Move;
import ch07.logic.MoveValidator;
...
public class ChessGui extends JPanel implements IPlayerHandler{
	...
	public ChessGui(ChessGame chessGame) {
		...
		// background
		URL urlBackgroundImg = getClass().getResource("/ch07/gui/img/bo.png");
	...
	private Image getImageForPiece(int color, int type) {
		...
		URL urlPieceImg = getClass().getResource("/ch07/gui/img/" + filename);
